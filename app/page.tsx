            ...
            <div className="flex flex-col items-center">
              ...
              >
                {isRecording ? (
                  ...
                  <svg className="w-16 h-16 text-[#2d8c4e]" fill="currentColor" viewBox="0 0 24 24">
          ...
          <section className="bg-white rounded-2xl p-8 mb-8 shadow-sm border border-gray-100">
            ...
            <div className="relative">
              <textarea
                ...
                className="w-full h-[160px] p-5 bg-[#f8f8f8] border border-gray-200 rounded-xl resize-none text-[#333] text-base placeholder-gray-400 focus:outline-none focus:border-[#2d8c4e] transition-colors"
              />
              {isRecording && (
              ...
              {SECTIONS.map((section) => (
                <section key={section} className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                  <div className="flex items-center justify-between mb-3">
                    <h3 className="text-sm font-semibold text-[#2d8c4e] tracking-widest uppercase">{section}</h3>
                    <button
                      onClick={() => copyField(section)}
                      disabled={!fields[section]}
                      className="flex items-center gap-1.5 text-xs px-3 py-1.5 rounded-md transition-all duration-150 disabled:opacity-30 disabled:cursor-not-allowed bg-[#f5f5f5] border border-gray-200 text-gray-500 hover:border-[#2d8c4e] hover:text-[#2d8c4e]"
                    >
                      {copiedField === section ? (
                        <>
                          <svg className="w-3.5 h-3.5 text-[#2d8c4e]" fill="currentColor" viewBox="0 0 20 20">
                            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                          </svg>
                          <span className="text-[#2d8c4e]">Kopierat</span>
                        </>
                      ) : (
                        <>
                  ...
                  <textarea
                    ...
                    className="w-full p-4 bg-[#f8f8f8] border border-gray-200 rounded-xl resize-none text-[#333] text-sm placeholder-gray-300 focus:outline-none focus:border-[#2d8c4e] transition-colors"
                  />
                </section>
              ))}
            </div>
